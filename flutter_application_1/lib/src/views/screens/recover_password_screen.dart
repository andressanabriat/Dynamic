      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 200), // Espacio ente botón atras y titulo
            
            Padding(
              padding: const EdgeInsets.only(right: 176.0), // Espacio desde el borde izquierdo
              child: Text(
            ...
            SizedBox(height: 30), // Espacio ente lema y Correo electronico
            ...
            SizedBox(height: 30), // Espacio ente Inicio de sesión y Correo electronico
