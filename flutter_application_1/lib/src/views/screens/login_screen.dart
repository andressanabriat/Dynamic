      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Align( // Boton registro
              alignment: Alignment.center, // Centra el texto
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center, // Alinea ambos elementos al centro
                children: [
                  Text(
                  ...
                  TextButton(
                    onPressed: () {}, // Accion del boton
                    child: Text(
                      'Regístrate',
                      style: TextStyle(
                        fontSize: 17, // Tamaño de texto
                        color: AppColors.mainBlue, // Color de texto azul
                      ),
                    ),
                  ),
                ],
