...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Widget> _screens = [
    EntrenamientosTab(), // Pestaña de Entrenamientos (Home)
    Center(child: Text('Información física')),
    Exercises(), // Pestaña "Ejercicios"
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      resizeToAvoidBottomInset: true, // ✅ Asegura que suba todo con el teclado
...
class EntrenamientosTab extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return SafeArea( // ✅ Añadimos SafeArea para evitar notch o barras
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              children: [
                _buildTrainingCard('Entrenamiento 1'),
                _buildTrainingCard('Entrenamiento 2'),
              ],
            ),
            SizedBox(height: 20),
            CustomButton(
